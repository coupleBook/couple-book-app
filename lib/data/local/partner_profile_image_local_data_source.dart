...
import 'entities/partner_profile_image_entity.dart';

class PartnerProfileImageLocalDataSource {
  static final PartnerProfileImageLocalDataSource instance =
  ...
  Future<void> savePartnerProfileImage(PartnerProfileImageEntity image) async {
    await SecureStorageHelper.setItem(
        _partnerProfileImageKey, jsonEncode(image.toJson()));
  }
  ...
  Future<PartnerProfileImageEntity?> getPartnerProfileImage() async {
    ...
    return data != null
        ? PartnerProfileImageEntity.fromJson(jsonDecode(data))
        : null;
  }
